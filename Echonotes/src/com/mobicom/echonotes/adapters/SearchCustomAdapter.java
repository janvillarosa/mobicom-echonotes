...
import com.mobicom.echonotes.activity.SearchResultsActivity;
...
public class SearchCustomAdapter extends BaseAdapter implements OnClickListener {
	...
	public SearchCustomAdapter(Activity a, ArrayList<ListModel> d,
			Resources resLocal) {
	...
	private class OnItemClickListener implements OnClickListener {
		...
		public void onClick(View arg0) {
			...
			SearchResultsActivity sct = (SearchResultsActivity) activity;
